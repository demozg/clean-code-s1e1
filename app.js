...
var incompleteTaskHolder=document.getElementById("incomplete-tasks");//list of incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="tasks__btn-edit button";

    deleteButton.className="tasks__btn-delete button";
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector(".tasks__btn-edit");
    var deleteButton=taskListItem.querySelector(".tasks__btn-delete");
